...
// 튜토리얼 완료 API
import { completeTutorial } from "@/src/entities/user/model/api/api";
      ...
      <div className="w-full max-w-sm mx-auto flex-1 flex flex-col items-center gap-3 px-2 min-h-0 overflow-y-auto">
        ...
        >
          ...
          <div
            ...
            role="list"
            aria-label={t("step3.aria.popularRecipesList")}
          >
            {popularRecipes.length === 0 ? (
              ...
              popularRecipes.slice(0, 3).map((recipe, index) => (
                <motion.div
                  ...
                  aria-label={t("step3.aria.recipeItem", {
