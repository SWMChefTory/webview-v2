        ...
        {isLandscape ? (
          ...
          >
            ...
            >
              {/* ...버튼 동일... */}
              <button
                className="flex h-14 w-14 items-center justify-center rounded-full bg-orange-500 p-2 shadow-[0_2px_16px_rgba(0,0,0,0.32)] transition active:scale-95"
...
const RecipeStepPageReady = ({ id }: { id: string }) => {
  ...
  return <RecipeStep videoInfo={videoInfo} steps={steps} />;
};
