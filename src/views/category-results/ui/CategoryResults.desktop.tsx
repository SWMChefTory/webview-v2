...
export function CategoryResultsSkeletonDesktop() {
  return (
    <div className="flex flex-col w-full min-h-screen bg-gradient-to-b from-white to-gray-50/20">
      ...
      <div className="max-w-[1600px] mx-auto w-full px-8 pb-10">
    ...
    <div className="flex flex-col w-full min-h-screen bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-[1600px] mx-auto w-full px-8 py-12 lg:py-16">
        <div className="flex items-baseline gap-4">
          <h1 className="font-bold text-gray-900 truncate text-5xl tracking-tight">
            {categoryName}
          </h1>
          <span className="font-medium text-gray-500 shrink-0 text-3xl">
            {t("header.suffix")}
          </span>
        </div>
