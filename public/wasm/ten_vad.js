var createVADModule = (() => {
  ...
  return function (createVADModule) {
    ...
    var aa = a.print || console.log.bind(console),
      x = a.printErr || console.warn.bind(console);
    Object.assign(a, p);
    p = null;
    var y;
    ...
    function ca() {
      return y || (!r && !u) || 'function' != typeof fetch
                    ...
                    if (g & 128) {
                      ...
                      if (192 == (g & 224)) q += String.fromCharCode(((g & 31) << 6) | I);
                        ...
                        g =
                          224 == (g & 240)
                            ? ((g & 15) << 12) | (I << 6) | Y
                            : ((g & 7) << 18) | (I << 12) | (Y << 6) | (f[n++] & 63);
                        65536 > g
                          ? (q += String.fromCharCode(g))
                          : ((g -= 65536),
                            (q += String.fromCharCode(55296 | (g >> 10), 56320 | (g & 1023))));
                      }
    ...
    (function () {
      ...
      (function () {
        return y ||
          ...
          ? m(c)
          : fetch(R, { credentials: 'same-origin' }).then(function (d) {
    ...
    function Z() {
      ...
      if (!(0 < N)) {
        if (a.preRun)
          for ('function' == typeof a.preRun && (a.preRun = [a.preRun]); a.preRun.length; ) ba();
        U(K);
        0 < N ||
          (a.setStatus
            ? (a.setStatus('Running...'),
...
// Expose to global scope for non-module script usage
